...
<?= $hiddenInput ?>
<div class="cropper-wraper2 webuploader-element-invisible">
    <div class="img-container2">
        <img src="" alt="" />
    </div>
    <div class="upload-btn2">上传</div>
</div>
<?php $this->registerJs(<<<Js
        ...
        return {
            init: function( selectCb ) {
                ...
                uploader.on('fileQueued', function( _file ) {
                    ...
                    $('.cropper-wraper2').addClass('webuploader-element-invisible');
    ...
    // ---------  Crpper ---------------
    // ---------------------------------
    var Croper2 = (function() {
        var container = $('.cropper-wraper2');
        var image = container.find('.img-container2 img');
        var btn = $('.upload-btn2');
    ...
    Uploader2.init(function( src ) {
        Croper2.setSource( src );
        // 隐藏选择按钮。
        container.addClass('webuploader-element-invisible');
        // 当用户选择上传的时候，开始上传。
        Croper2.setCallback(function( data ) {
            Uploader2.crop(data);
            Uploader2.upload();
        });
    });
