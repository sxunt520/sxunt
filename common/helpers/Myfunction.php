...
class Myfunction
{
     ...
     * @return array
     */
    public static function GetImageInfoVal($ImageInfo,$val_arr) {
        $InfoVal = "未知";
    ...
    public static function GetImageInfo($img) {
        ...
        $ExposureProgram = array("未定义", "手动", "标准程序", "光圈优先", "快门优先", "景深优先", "运动模式", "肖像模式", "风景模式");
        ...
        if ($exif===false) {
            ...
            */
                ...
                "测光模式" => self::GetImageInfoVal(@$exif['EXIF']['MeteringMode'],$MeteringMode_arr),
                "光源" => self::GetImageInfoVal(@$exif['EXIF']['LightSource'], $Lightsource_arr),
                "闪光灯" => self::GetImageInfoVal(@$exif['EXIF']['Flash'], $Flash_arr),
